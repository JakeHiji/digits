          ...
          <Grid centered stackable container columns={3}>
            ...
            <Grid.Column textAlign={'center'}>
              ...
              <Header as={'h3'} inverted>
                This address book enales any number of useres to register
                and save their business contacts. You can only see the contacts you
                have created.
              </Header>
            </Grid.Column>
            ...
            <Grid.Column textAlign={'center'}>
              ...
              <Header as={'h3'} inverted>
                For each contact, you can save their name, address, and phone
                number.
              </Header>
            </Grid.Column>
            ...
            <Grid.Column textAlign={'center'}>
              ...
              <Header as={'h3'} inverted>
                Each time you make contact with a contact, you can write a note
                that summarizes the conversation. This note is saved along with
                a timestamp with the contact.
              </Header>
            </Grid.Column>
          </Grid>
        </div>
