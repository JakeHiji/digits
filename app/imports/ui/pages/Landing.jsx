...
class Landing extends React.Component {
  render() {
    return (
        <div className={'digits-background-header'} >
          <Grid centered stackable container columns={3}>
            ...
            <Grid.Column textAlign={'center'}>
              ...
              <Header as={'h3'} inverted>
                For each contactm you can save their name, address, and phone number.
              </Header>
            </Grid.Column>
            ...
            <Grid.Column textAlign={'center'}>
              ...
              <Header as={'h3'} inverted>
                ...
                summarizes the conversation. This note is saved along with a
                timestamp with the contact.
              </Header>
            </Grid.Column>
